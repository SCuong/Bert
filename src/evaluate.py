...
def evaluate_bert(model_dir=None):
    ...
    with open(BERT_METRICS_PATH, "w", encoding="utf-8") as f:
        json.dump(bert_metrics, f, indent=4, ensure_ascii=False)
    print(f"[+] Đã lưu BERT metrics tại: {BERT_METRICS_PATH}")
    ...
    # Lấy 10 False Positives và 10 False Negatives
    ...
    print(f"[+] Đã trích xuất 20 ca dự đoán sai đặc trưng tại: {ERROR_CASES_PATH}")
